 ...
 * @author Advogados
 */
public class TelaNf extends javax.swing.JFrame {
    ...
    private void salvar_acordo() {

        String sql = "update tbacordo set notafiscal=? where contrato=?";

        try {
            PreparedStatement pst = conexao.prepareStatement(sql);


            pst.setString(1, txtNf.getText());
        ...
        String sql = "update tbparcelas set notafiscal=? where contrato=?";
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtNf, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaNf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
